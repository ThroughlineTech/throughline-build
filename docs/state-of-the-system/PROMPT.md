...
- The architecture document [docs/throughline-build-architecture.md](../throughline-build-architecture.md) is now maintained as an as-built current reference. Source and generated help remain authoritative; any point-in-time disagreement is treated as a documentation bug rather than preserved as an architectural promise.
