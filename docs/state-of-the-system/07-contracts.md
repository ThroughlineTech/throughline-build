...
- **Fenced-block payload protocol (op-27).** Spec at [docs/op-docs/complete/op-27-worker-result-fenced-payloads.md](../op-docs/complete/op-27-worker-result-fenced-payloads.md). Per-phase refs and consumers (validation/resolution sites):
