...
public static class CliVerbRegistryFactory
{
    ...
    [
        ...
        ("conductor", CliVerbKind.Conductor, true),
        ("profile", CliVerbKind.Profile, true),
        ("sweep", CliVerbKind.Sweep, false),
        ("candidate", CliVerbKind.Candidate, false),
        ("worker", CliVerbKind.Worker, false),
        ...
        ("attachments", CliVerbKind.Attachments, false),
        ("attachment", CliVerbKind.Attachment, false),
