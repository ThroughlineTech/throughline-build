...
Usage:
  ...
  build chain <ticket-id> [--agent <name>] [--agent-plan <name>] [--agent-implement <name>] [--agent-review <name>] [--debug] [--no-auto-resolve]  Run the full chain (plan -> implement -> review -> ship cycle) for a single ticket; streams per-phase output to stdout
