...
// production stderr diagnostics ("[WorkerResultParser] ...") would otherwise
// spew into the test runner on every green run. Set exactly once at assembly
// load - never toggled per-test - so there is no cross-test race. See
// WorkerDiagnostics in ThroughlineBuild.Workers.Common.
